...
function FormContact() {
  ...
  return (
    <form class=" w-4/5">
      ...
      <label for="" class="w-full block py-3 text-[var(--bg-color)] font-semibold">Your Name</label>
      <input name="from_name" type="text" placeholder="Your Name" class="input input-bordered lg:w-1/2 w-[100%] max-w-xs"/> <label for="" class="w-full block py-3 text-[var(--bg-color)] font-semibold">Your Email</label><input name="form_email" type="email" placeholder="Your Email" class="input input-bordered lg:w-1/2 w-[100%] max-w-xs"/><label for="" class="w-full block pt-7 text-[var(--bg-color)] font-semibold">Your Message</label><textarea name="message" class="textarea w-full h-52 my-5" placeholder="Your Message"></textarea><button class="btn bg-[var(--bg-color)] text-[var(--primary-color)] font-semibold py-4 px-8 hover:bg-transparent hover:scale-[105%]" disabled>Send</button>
