function Icons() {
  return (
    <div className="flex gap-6">
      ...
      >
        <svg
          class="w-6 h-6 text-yellow-500 transition-all duration-[0.3s] ease-in hover:text-[#0d54c0] dark:text-[var(--primary-color)]"
          aria-hidden="true"
      ...
      <a href="https://github.com/saramohamed124/" target="_blank" rel="noreferrer">
        <svg
          class="w-6 h-6 text-yellow-500 transition-all duration-[0.3s] ease-in hover:text-[#000000] dark:text-[var(--primary-color)]"
          aria-hidden="true"
          xmlns="http://www.w3.org/2000/svg"
          fill="currentColor"
          viewBox="0 0 24 24"
      ...
      >
        <svg
          className="w-6 h-6 text-yellow-500 transition-all duration-[0.3s] ease-in hover:text-[#0A66C2] dark:text-[var(--primary-color)]"
          aria-hidden="true"
          xmlns="http://www.w3.org/2000/svg"
          fill="currentColor"
          viewBox="0 0 24 24"
      ...
      <svg
                className="w-6 h-6 text-yellow-500 transition-all duration-[0.3s] ease-in hover:text-[#C13584] dark:text-[var(--primary-color)]"
                fill="currentColor"
                viewBox="0 0 256 256" 
